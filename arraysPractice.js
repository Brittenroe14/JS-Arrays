...
var getRandomArbitrary = function finder(numbers) {
...
function removeItem (myGroceryList, pizza)
function addItem (myGroceryList, apples)
...
var users = {
  name: 'Britten',
  email: 'brroe@fake.com',
  password: 'fake123',
  username: 'Brittenroe14'
};
